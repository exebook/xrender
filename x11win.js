var glxwin = require('./build/Release/x11win.node')
TGLXWin = kindof()
...
TGLXWin.can.colorText = function(x, y, w, h, TXT, CLR) { glxwin.color_text_new(this.handle, x, y, w, h, TXT, CLR) }
...
glxwin.onSize = function (handle, w, h) {
	var O  = this.findObject(handle)
	if (!O) return // must be called from winx11.h:win.create
